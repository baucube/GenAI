...
# Initialize the LLM
llm = ChatOllama(
    # model="llama3:latest",  # Corrected model name
...
planner = Agent(
    ...
    verbose=True,
    llm=llm  # Explicitly assign the LLM
)
...
editor = Agent(
    ...
    backstory=(
        ...
        "provides balanced viewpoints when providing opinions or assertions, and avoids major "
